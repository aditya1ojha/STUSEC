    ...
    <div name="home" className='h-screen w-full text-white'>
        ...
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-start h-full w-full px-4'>
            ...
            <div className='flex flex-col justify-center h-full'>
                ...
                <h2 className='text-lg flex items-center justify-center py-10 text-yellow-300'>JEC'S BIOMETRIC ATTENDANCE SYSTEM</h2>
                <a className='text-xl flex items-center justify-center' href='https://github.com/aditya1ojha/STUSEC' target='_blank'>
